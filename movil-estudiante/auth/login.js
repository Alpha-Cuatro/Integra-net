...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('loginForm')?.addEventListener('submit', (e) => {
        ...
        if (usuario.rol !== 'estudiante') {
            return mostrarModal({ titulo: 'Acceso no disponible', mensaje: 'Esta app es solo para estudiantes. Los docentes y administradores deben usar la aplicación web.', icono: 'fa-solid fa-triangle-exclamation', tipo: 'error' });
        }
